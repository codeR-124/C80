...
function submit()
{
    ...
    {
        display_student_array.push("<h4>NAME -" +length_of_name_of_the_student_array[k] + "<h4>");
...
function sort()
{
    ...
    for (var k=0; k<length_of_name_of_the_student_array; k++)
    {
        display_student_array_sorting.push("<h4>NAME -" +length_of_name_of_the_student_array[k] + "<h4>");
